        ...
        NavigationStack {
            ScrollView {
                VStack(alignment: .leading, spacing: 22) {
                    ...
                    Text("Translation needs an internet connection. Nothing leaves this device until you explicitly choose Translate. Jev Relay can then send the English text and situational context you choose to TypeSafe / Jev for four routing decisions and, when needed, to Nebius / Qwen for a Dutch translation.").font(.relay(.body))
                    VStack(alignment: .leading, spacing: 14) {
                        ...
                        ConsentPoint(icon: "person.crop.circle.badge.checkmark", title: "Anonymous cloud identity", detail: "An anonymous Supabase identity is created only after you consent and explicitly choose Translate. Its tokens stay in this device’s Keychain.")
                    }
                    ...
                    Text("You can revoke consent or request deletion of the anonymous cloud identity in Settings. Deletion cannot recover that identity.").font(.relay(.subheadline)).foregroundStyle(RelayStyle.muted)
                    VStack(spacing: 10) {
