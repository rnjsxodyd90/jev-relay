...
| App Store submitted, approved, or released | Unsupported | Version 1.0 remains Prepare for Submission; manual release retained | Prohibited |
| No provider retention or Data Not Collected | Unsupported | Retention/logs/backups/residency/subprocessors and privacy attestation unresolved; App Privacy is unstarted/unpublished | Prohibited |
